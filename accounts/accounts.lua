...
function onStart()
	...
	guiCreateStaticImage(17, 28, 350, 145,"images/sourcemode.png",false,windows["login"])
	...
	guiCreateStaticImage(71, 20, 174, 109, "images/sourcemode.png", false, windows["register"])
	...
	guiCreateStaticImage(119, 20, 150, 68, "images/sourcemode.png", false, windows["recovery"])
